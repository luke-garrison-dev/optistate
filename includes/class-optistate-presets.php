...
class OPTISTATE_Presets
{
    ...
    public static function get_presets(): array
    {
        ...
        self::$presets = [
            ...
            "balanced" => [
                ...
                "config" => self::build_config(self::get_overrides("balanced")),
            ],
            "max_speed_security" => [
                ...
                "config" => self::build_config(
                    self::get_overrides("max_speed_security")
                ),
            ],
            "max_speed_only" => [
                ...
                "config" => self::build_config(
                    self::get_overrides("max_speed_only")
                ),
            ],
            "max_security_only" => [
                ...
                "config" => self::build_config(
                    self::get_overrides("max_security_only")
                ),
            ],
        ];
    ...
    private static function get_overrides(string $key): array
    {
        $overrides = [
            "balanced" => [
                "performance_features" => [
    ...
    private static function build_config(array $overrides): array
    {
        return self::merge_recursive(self::get_base_config(), $overrides);
    }
